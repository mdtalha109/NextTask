...

{
        !loading && 
          <div
            role="button"
            className="bg-card text-2xl p-4 flex justify-center items-center rounded-lg shadow-lg overflow-hidden transition-transform duration-300 hover:scale-105 border-2 border-black border-dashed"
